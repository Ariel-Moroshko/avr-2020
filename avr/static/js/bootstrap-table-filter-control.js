...
!function ($) {
            ...
            if (!column.filterControl) {
                ...
                switch (column.filterControl.toLowerCase()) {
                    ...
                    case 'select':
                        ...
                        html.push(sprintf('<select class="%s custom-select form-control px-auto" style="width:100%;min-width: 80px; visibility: %s;"></select>',
                            column.field, isVisible))
                        break;
                    case 'datepicker':
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.filterControl && this.options.filterShowClear) {
            ...
            if (!$btnClear.length) {
              $btnClear = $([
                    '<button class="btn btn-clear-table-filters" ' +
                        'type="button">',
